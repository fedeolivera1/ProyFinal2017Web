 ...
 *         &lt;element name="listaProdSinc" type="{http://localhost:8080}ResultProductoASinc" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="listaTpSinc" type="{http://localhost:8080}ResultTipoProdASinc" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="listaUnidadSinc" type="{http://localhost:8080}ResultUnidadASinc" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
