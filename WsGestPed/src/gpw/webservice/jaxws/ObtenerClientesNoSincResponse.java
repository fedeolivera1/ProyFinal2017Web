...
@XmlRootElement(name = "obtenerClientesNoSincResponse", namespace = "http://localhost:8080")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerClientesNoSincResponse", namespace = "http://localhost:8080")

public class ObtenerClientesNoSincResponse {
